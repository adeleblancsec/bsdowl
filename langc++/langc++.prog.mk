...
# Date: Sat Dec 20 18:06:54 CET 2014
...
SRCS.${program:T}=	${SRCS}
.endif
.if exists(${program}.cpp)&&empty(SRCS.${program:T}:M${program}.cpp)
SRCS.${program:T}+=	${program}.cpp
.endif
.endif
.endfor
...
OBJS.${program:T}=	${SRCS.${program:T}:N*.hpp:C/\.cpp$/.o/}
.endif
...
${program}:
	${CXXLINKTOOL} -o ${.TARGET} ${.ALLSRC:N*.h} ${LDADD}
.endfor
